  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px]",
  {
    variants: {
      variant: {
        ...
        jutsu: "bg-primary text-primary-foreground hover:scale-105 hover:chakra-glow transition-all active:scale-95 font-serif uppercase tracking-widest",
        leaf: "bg-secondary text-secondary-foreground border-2 border-foreground/10 hover:bg-secondary/90",
      },
      size: {
